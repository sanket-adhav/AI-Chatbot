...
from app.workers.document_processor import process_document_background
from app.services.rag.vector_store import delete_by_document_id

router = APIRouter(prefix="/documents", tags=["documents"])

from pathlib import Path

UPLOAD_DIR = Path(__file__).parent.parent.parent.parent / "data" / "uploads" / "documents"
...
def upload_document(
    ...
    background_tasks.add_task(process_document_background, db, db_doc.id)
